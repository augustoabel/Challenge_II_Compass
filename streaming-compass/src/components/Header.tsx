            ...
            <nav className="lg:justify-center lg:items-center font-sans font-semibold ">
              <ul className="flex space-x-4 w-80 justify-between lg:w-full text-white flex-wrap lg:flex-nowrap gap-6">
                <li className="flex items-center ">
                  <NavLink
                    to="/home"
                    className={` ${location.pathname === '/home' ? 'text-blue-500' : ''
                      }`}
                  >
                    <svg
                      width="20"
                      ...
                      className={`inline-block align-text-top mr-2  ${location.pathname === '/home'
                        ? 'text-blue-500'
                        : 'text-gray-300'
                        }`}
                    >
                ...
                <li className="flex items-center">
                  <NavLink
                    to="/series"
                    className={`flex items-center ${location.pathname === '/series' ? 'text-blue-500' : ''
                      }`}
                  >
                    <svg
                      width="24"
                      ...
                      fill="none"
                      xmlns="http://www.w3.org/2000/svg"
                      className={`inline-block align-text-top mr-2 ${location.pathname === '/series'
                        ? 'text-blue-500'
                        : 'text-gray-300'
                        }`}
                    >
                ...
                <li className="flex items-center">
                  <NavLink
                    to="/filmes"
                    className={` flex items-center ${location.pathname === '/filmes' ? 'text-blue-500' : ''
                      }`}
                  >
                    <svg
                      width="24"
                      ...
                      fill="none"
                      xmlns="http://www.w3.org/2000/svg"
                      className={`inline-block align-text-top mr-2 ${location.pathname === '/filmes'
                        ? 'text-blue-500'
                        : 'text-gray-300'
                        }`}
                    >
                ...
                <li className="flex lg:flex-row items-center justify-center flex-1 mt-4 lg:mt-0">
                  <NavLink
                    to="/actors"
                    className={` flex items-center  ${location.pathname === '/actors' ? 'text-blue-500' : ''
                      }`}
                  >
                    <svg
                      width="24"
                      ...
                      fill="none"
                      xmlns="http://www.w3.org/2000/svg"
                      className={`inline-block align-text-top mr-1 ${location.pathname === '/actors'
                        ? 'text-blue-500'
                        : 'text-gray-300'
                        }`}
                    >
